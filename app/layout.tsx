...
export const metadata: Metadata = {
  ...
  verification: {
    google: ["kDtgSpzmgDHINIgkYUxmUwk0izdzlD_IdbRH3bJ3KDc", "8wsGlX3fZbd7taCNvH2LkYwBdJ9CASSYs11WZ5CpdZo"],
  },
};
  ...
  return (
    <html lang="en">
      <head>
        {/* Google tag (gtag.js) */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=AW-18143343998"
