...
const experiences = [
  ...
  },
  {
    ...
    image: "/images/general/cruises.jpg",
  ...
  },
  {
    ...
    image: "/images/general/mountainos.jpg",
  ...
  return (
    <>
      ...
      <section className="relative h-[40vh] min-h-[300px]">
        <Image
          src="/images/general/experiences.jpg"
      ...
      {experiences.map((exp, index) => (
        <section
          ...
          className="relative"
        >
          <div className="grid lg:grid-cols-2 gap-4 lg:gap-8 min-h-[400px] lg:min-h-[500px]">
            {/* Photo */}
            <div
              className={`relative h-64 sm:h-80 lg:h-auto rounded-xl overflow-hidden ${
